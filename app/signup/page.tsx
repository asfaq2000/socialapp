...
export default function SignupPage() {
  ...
  const [message, setMessage] = useState("Create your account to start connecting.");
  ...
  async function handleSignup(event: FormEvent<HTMLFormElement>) {
    ...
    setMessage("Account created. Verify your email and log in once confirmed.");
  }
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] bg-slate-50 px-6 py-12 text-slate-900">
      <div className="mx-auto max-w-md rounded-3xl bg-white p-8 shadow-lg shadow-slate-200">
        ...
        <p className="mt-2 text-sm text-slate-600">Join the network and start building friend connections.</p>
